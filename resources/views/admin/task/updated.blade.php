                            ...
                            <div class="card-body">
                                    ...
                                    <li class="nav-item">
                                        <a href="#account" role="tab" id="account-tab"
                                           ...
                                           aria-controls="account" aria-selected="true">
                                            ...
                                            <span class="d-none d-sm-block">تعديل عميل </span>
                                        </a>
                                    </li>
                                    <!-- <li class="nav-item">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade mt-2 show active" id="account" role="tabpanel"
                                        ...
                                        <!-- Account form starts -->
                                        <form method="post" action="{{url('dashboard/client/updated/'.$client->id)}}">
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" id="users-edit-username"
                                                                   class="form-control" name="name" value="{{old('name') != null ? old('name') :$client->name}}" placeholder="الاسم " required
                                                                   aria-invalid="false">
                                                            @if ($errors->has('name'))
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="tel" id="mob1" name="phone1" value="{{old('phone1')!= null ? old('phone1') :$client->phone1}}" class="form-control"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="tel" name="phone2" value="{{old('phone2') != null ? old('phone2') :$client->phone2}}" id="mob2" class="form-control"
                                                                   placeholder="رقم الموبايل " required
                                                                   aria-invalid="false" maxlength="11">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="tel" id="mob3" name="phone_tracking" value="{{old('phone_tracking')  != null ? old('phone_tracking') :$client->phone_tracking}}" class="form-control"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" id="users-edit-address"
                                                                   class="form-control" name="address" value="{{old('address') != null ? old('address') :$client->address}}" placeholder="العنوان " required
                                                                   aria-invalid="false">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" id="users-edit-company" name="job" value="{{old('job') != null ? old('job') :$client->job}}"
